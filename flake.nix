    ...
    let
      ...
      hosts =
        ...
        "GREATBELOW.localdomain" = slashUsersHost {
          modules = [ ./shell.nix ./dracula-theme.nix ./zsh.nix ./gui.nix ./mac-host.nix ./my-email.nix ] ++ dev-modules;
          stateVersion = "21.11";
          system = "x86_64-darwin";
        };
        "thinklappy" = slashHomeHost {
          modules = [ ./shell.nix ./dracula-theme.nix ./zsh.nix ./gui.nix ./nixos-host.nix ./my-email.nix ];
          stateVersion = "21.11";
          system = "x86_64-linux";
        };
      };
